...
public class FragmentActivity extends AppCompatActivity implements PassingDataFromSendingFragmentToReceivingFragment,PassingDataFromReceivingFragmentToSendingFragment {
    ...
    @Override
    public void passingDataFromSendingFragmentToReceivingFragment(String textData) {
    ...
    @Override
    public void passingDataFromReceivingFragmentToSendingFragment() {
