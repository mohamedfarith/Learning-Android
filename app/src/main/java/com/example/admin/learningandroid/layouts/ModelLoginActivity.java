    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_sign_up:
                ...
                } else if (mRegistrationNumber.isEmpty()) {
                    message = "enter valid register number";
                } else if(savedName.isEmpty()&&savedRegNumber.isEmpty()){
            ...
            case R.id.btn_login:
                ...
                if (!name.isEmpty() && !registrationNumber.isEmpty()) {
                    if (name.equals(etName.getText().toString().trim()) && (registrationNumber.equals(etRegistrationNumber.getText().toString()))) {
